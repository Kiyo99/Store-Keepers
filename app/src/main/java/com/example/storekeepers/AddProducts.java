...
//                    pd.dismiss();
//                    Toast.makeText(AddProducts.this, "All fields are required!", Toast.LENGTH_SHORT).show();
//                }
//                else if (imageChecker == null) {
//                    pd.dismiss();
//                    Toast.makeText(AddProducts.this, "Please upload an image first", Toast.LENGTH_SHORT).show();
//                }
//                else {
...
//                                    pd.dismiss();
//                                    Toast.makeText(AddProducts.this, "Successfully uploaded your product", Toast.LENGTH_SHORT).show();
//                                    finish();
//                                }
...
//                                    pd.dismiss();
//                                    Toast.makeText(AddProducts.this, "Error uploading your product", Toast.LENGTH_SHORT).show();
//                                }
//                            });
//
//                        }
...
//                    Toast.makeText(AddProducts.this, "get failed with " + task.getException(), Toast.LENGTH_SHORT).show();
//
//                }
//            }
//        });
...
//                Toast.makeText(AddProducts.this, error, Toast.LENGTH_LONG).show();
//            }
...
//                    @Override
//                    public void onFailure(@NonNull Exception e) {
//                        Toast.makeText(AddProducts.this, "Failed to get URL", Toast.LENGTH_LONG).show();
//                    }
//                });
//            }
